...
exports.validateConfigFile = exports.getColumnIdForAction = void 0;
...
const validateConfigFile = (configFile) => {
    const doMatchingValuesExist = ({ sourceArray, matcherArray }) => {
    ...
    const areAllMatchesTruthy = (matches) => {
    ...
    const matchingEvents = configFile.validEvents.filter((validEvent, index) => {
        ...
        const errorFormatter = (matchingArray) => {
        ...
        if (matched) {
            const errorMesssageContent = matchingName ||
                matchingEventTypes ||
                matchingBranches ||
                matchingColumnId;
            const errorMessage = `Duplicate config found:${os.EOL}${errorFormatter(errorMesssageContent)}`;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getShortcutIdFromBranchName = void 0;
...
exports.getShortcutIdFromBranchName = getShortcutIdFromBranchName;
...
const shortcut_1 = __nccwpck_require__(250);
const github_events_1 = __nccwpck_require__(20);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const shortcutStoryId = (0, shortcut_1.getShortcutIdFromBranchName)(githubActionEvent.branch, BRANCH_PATTERN);
